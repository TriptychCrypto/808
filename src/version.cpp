...
// Copyright (c) 2014 The Boko developers
...
// for both Bokod and Boko(-qt), to make it harder for attackers to
// target servers or GUI users specifically.

// For the current run of Boko releases, the client name should be selected from
