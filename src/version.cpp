...
// Copyright (c) 2014 The Deku developers
...
// for both Dekud and Deku(-qt), to make it harder for attackers to
// target servers or GUI users specifically.

// For the current run of Deku releases, the client name should be selected from
